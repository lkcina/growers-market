...
const ListWishlist: React.FC<Props> = ({ wishlistValues, onWishlistRemove, onWishlistCreate, wishlistSearchResult }: Props): JSX.Element => {
    return (
        <div>
            {wishlistValues.length > 0 ? (
                wishlistSearchResult.length > 0 ? (wishlistValues.map(s => {
